...
app.config(function ($translateProvider) {
    $translateProvider.translations('en', {
        ...
        WORKSHOP1: '<table class="workshop_table"><tr><td>What:</td><td>EU Presidency Translator workshop</td></tr><tr><td>Where:</td><td><a href="http://www.nlib.ee/en" target="_blank">Estonian National Library [TBC]</a></td></tr><tr><td>When:</td><td>August 24, 2017</td></tr></table>',
        WORKSHOP2: 'About',
        WORKSHOP3: 'This workshop for EU Council Presidency translators, staff members, and Estonian public sector communications professionals will introduce the EU Presidency Translator, an automated translation service specially designed for the 2017 Estonian Presidency of the Council of the European Union.',
        WORKSHOP4: 'The EU Presidency Translator is freely available to all Estonian public sector translators for the duration of the Estonian EU Council Presidency. The service provides the world’s best automated translation systems for Estonian, built with the latest innovations in language technology, and can be used to translate texts, full documents, and websites.',
        WORKSHOP5: 'In this workshop, organized by the Tallinn-based language technology company Tilde, translators and other communications professionals will<ul><li>learn how to leverage machine translation in their work, making their daily translation tasks easier and more efficient,</li><li>gain insight into the EU’s efforts to provide a pan-European machine translation infrastructure for all public administrations and citizens,</li><li>acquire practical knowledge about how to boost their translation productivity with the EU Presidency Translator.</li></ul>',
        WORKSHOP6: 'Agenda',
        WORKSHOP7: '<table class="workshop_table"><tr><td>13:30-13:45:</td><td>Trends in machine translation technology (in English, presented by Tilde)</td></tr><tr><td>13:45-14:00:</td><td>About the EU’s automated translation platform, CEF eTranslation (in English, presented by Tilde)</td></tr><tr><td>14:00-14:15:</td><td>Introducing the EU Presidency Translator for Estonia (in Estonian, presented by Tilde)</td></tr><tr><td>14:15-15:00:</td><td>EU Presidency Translator for EU Council Presidency translators and staff – how to post-edit Estonian texts with online translation tool (in Estonian, presented by Tilde)</td></tr><tr><td>15:00-15:20:</td><td>Coffee break</td></tr><tr><td>15:20-16:00:</td><td>EU Presidency Translator for public sector translators – how to post-edit Estonian texts with the SDL Trados Studio plugin (in Estonian, presented by Tilde)</td></tr></table>',
    ...
    .translations('ee', {
        ...
        WORKSHOP1: '<table class="workshop_table"><tr><td>Üritus:</td><td>EL-i eesistumise tõlketööriista kasutamise töötuba</td></tr><tr><td>Toimumiskoht:</td><td><a href="http://www.nlib.ee/kuppelsaal-4/" target="_blank">Rahvusraamatukogu Kuppelsaal</a></td></tr><tr><td>Aeg:</td><td>24. august 2017</td></tr></table>',
        WORKSHOP2: 'Teave',
