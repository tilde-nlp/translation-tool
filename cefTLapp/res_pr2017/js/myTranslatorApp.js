...
app.config(function ($translateProvider) {
    $translateProvider.translations('en', {
        ...
        WORKSHOP1: '<table class="workshop_table"><tr><td>What:</td><td>EU Presidency Translator workshop</td></tr><tr><td>Where:</td><td><a href="http://www.nlib.ee/en" target="_blank">Estonian National Library [TBC]</a></td></tr><tr><td>When:</td><td>[TBC]</td></tr></table>',
        WORKSHOP2: 'About',
