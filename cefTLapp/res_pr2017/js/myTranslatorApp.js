...
var app = angular.module("myTranslatorApp", ['ngRoute', 'angular.filter', 'pascalprecht.translate'])
    .run(function ($rootScope) {
        ...
        $rootScope.sourceLanguageOrder = ["en", "de", "bg", "cs", "da", "el", "es", "et", "fi", "fr", "ga", "hr", "hu", "it", "lt", "lv", "mt", "nl", "pl", "pt", "ro", "sk", "sl", "sv"];
        $rootScope.targetLanguageOrder = ["de", "en", "bg", "cs", "da", "el", "es", "et", "fi", "fr", "ga", "hr", "hu", "it", "lt", "lv", "mt", "nl", "pl", "pt", "ro", "sk", "sl", "sv"];
        console.log('init');
    })
...
app.config(function ($translateProvider) {
    $translateProvider.translations('en', {
        ...
        CONTACT1: 'For more information about Translate 2018, or to receive a consultation about how to use the service, please contact us at info@translate2018.eu.',
        ...
        .translations('de', {
            ...
            CONTACT1: 'Wenn Sie mehr über Translate 2018 erfahren möchten oder Beratung zum Umgang mit dem Service suchen, kontaktieren Sie uns bitte unter info@translate2018.eu.',
