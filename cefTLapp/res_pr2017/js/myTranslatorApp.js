...
app.config(function ($translateProvider) {
    $translateProvider.translations('en', {
        ...
        WORKSHOP2: '<p>Registration is mandatory. Please fill out and submit the registration form below before 7 February 2018 .</p><br/><br/>About',
        ...
        .translations('bg', {
            ...
            WORKSHOP2: '<p>Регистрацията е задължителна. Моля, попълнете и изпратете регистрационната форма до 7 февруари 2018 г.</p><br/><br/>About',
            WORKSHOP3: 'Семинарът  „Преводач 2018“ е предназначен за преводачите и служителите към Министерството за Българското председателство на Съвета на ЕС и за работещите в областта на връзките с обществеността в публичния сектор. На семинара ще бъде представена системата <a target="_blank" href="https://eu2018bg.bg/bg/translation">„Преводач“</a> за Председателството на Съвета на ЕС – инструмент за автоматичен превод, създаден специално за Българското председателство на Съвета на Европейския съюз през 2018 г.</p><p>Системата „Преводач“ за Председателството на Съвета на ЕС е инструмент за многоезикова комуникация, който позволява на потребителите да превеждат автоматично текстове, документи и уеб страници от и на български и английски език. В „Преводач“ за Председателството на Съвета на ЕС са вградени системи за машинен превод между български и английски, които са изградени на основата на невронни мрежи и използват изкуствен интелект и машинно обучение. Системите, базирани на невронни мрежи, анализират пълния контекст, в който се появява дадено изречение, и предлагат по-ясен и разбираем превод, стилистично близък до превода, направен от човек.',
